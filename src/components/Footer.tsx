                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 pb-12">
                    ...
                    <div className="col-span-1 lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div className="flex gap-3">
                            <a className="size-9 rounded-full bg-[#f0ddcf] dark:bg-[#3a1c15] text-primary flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-300 shadow-sm" href="https://www.instagram.com/colares.dias.semijoias" target="_blank" rel="noreferrer">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="flex flex-col gap-4">
                            <a className="group flex items-center gap-3 bg-[#25D366]/10 p-3 rounded-lg border border-[#25D366]/20 hover:bg-[#25D366] transition-all duration-300" href="https://wa.me/5561982865191">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-white">+55 (61) 98286-5191</p>
                                </div>
                            </a>
                            <a className="flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 hover:text-primary transition-colors" href="mailto:contato@colaresdias.com.br">
                                <span className="material-symbols-outlined text-lg">mail</span>
                                contato@colaresdias.com.br
                            </a>
                        </div>
                    </div>
                </div>
