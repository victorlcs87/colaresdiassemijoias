...
export function Footer() {
    return (
        <footer className="bg-white dark:bg-[#152a20] border-t border-[#e7f3ed] dark:border-[#2a4538] mt-auto relative pt-12">
            <div className="max-w-[1440px] mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 pb-12">
                    ...
                    <div className="col-span-1 lg:col-span-1 flex flex-col gap-6">
                        <div className="flex items-center gap-2 text-slate-900 dark:text-white">
                            ...
                            <span className="text-xl font-bold tracking-tight">Lojinha da Lari</span>
                        </div>
                        <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                            Moda moderna e compras simplificadas. Conectamos você diretamente às últimas tendências via WhatsApp para uma experiência humanizada e personalizada.
                        </p>
                        <div className="flex gap-3">
                            <a className="size-9 rounded-full bg-[#f0f9f5] dark:bg-[#1e362a] text-primary flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-300 shadow-sm" href="#">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="flex flex-col gap-4">
                            <a className="group flex items-center gap-3 bg-[#25D366]/10 p-3 rounded-lg border border-[#25D366]/20 hover:bg-[#25D366] transition-all duration-300" href="https://wa.me/5511999999999">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-slate-900 dark:text-white group-hover:text-white">+55 (11) 99999-9999</p>
                                </div>
                            </a>
                            <a className="flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 hover:text-primary transition-colors" href="mailto:oi@lojinhadalari.com">
                                <span className="material-symbols-outlined text-lg">mail</span>
                                oi@lojinhadalari.com
                            </a>
                        </div>
                    </div>
                </div>
                ...
                {/* Bottom Footer */}
                <div className="border-t border-[#e7f3ed] dark:border-[#2a4538] py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500 dark:text-slate-400">
